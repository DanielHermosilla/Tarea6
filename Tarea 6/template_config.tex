...
\def\templatestyle {style1}        % Estilo del template: style1 a style4
...
\def\natbibrefstyle {ieeetr}       % Formato refs. natbib {apa,ieeetr,etc...}
\def\stylecitereferences {bibtex}  % Estilo refs. {apacite,bibtex,natbib,custom}
...
\def\pagemargintop {2.3}           % Margen superior página [cm]
